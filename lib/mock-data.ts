  ...
  return MOCK_VIDEOS.flatMap((video, videoIndex) => {
    ...
    return Array.from({ length: 10 }, (_, commentIndex) => {
      ...
      return {
        ...
        amount,
        text,
        timestamp: `2025-07-${String((videoIndex % 28) + 1).padStart(2, '0')}T${String(10 + commentIndex).padStart(2, '0')}:00:00Z`,
        replies: [],
      };
    });
  });
